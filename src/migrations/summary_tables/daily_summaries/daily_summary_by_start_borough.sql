-- nyctaxicab_daily_summary_by_start_borough
CREATE TABLE nyctaxicab_daily_summary_by_start_borough AS
SELECT 
    date_id, start_borough_id,
    COUNT(*) AS ride_count,
...
GROUP BY date_id, start_borough_id;