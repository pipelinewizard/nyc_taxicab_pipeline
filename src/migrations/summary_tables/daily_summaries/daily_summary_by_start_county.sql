-- nyctaxicab_daily_summary_by_start_county
CREATE TABLE nyctaxicab_daily_summary_by_start_county AS
SELECT 
    date_id, start_county_id,
    COUNT(*) AS ride_count,
...
GROUP BY date_id, start_county_id;